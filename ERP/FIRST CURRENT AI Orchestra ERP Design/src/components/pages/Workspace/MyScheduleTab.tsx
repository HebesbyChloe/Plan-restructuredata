...
import { Calendar, ChevronLeft, ChevronRight, Plus, TableProperties, BarChart3 } from "lucide-react";
import {
  WeeklyScheduleView,
  ShiftTimelineView,
  RequestsCard,
      ...
      >
        <Card className="p-4 bg-gradient-to-br from-ai-blue/5 to-purple-500/5 backdrop-blur-sm">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            {/* Left Side - View Type Toggle and Request Button */}
