...
import { getStatusColor } from "../utils/returnWarrantyTableHelpers";
...
export function OrderDateColumn({ order, onOrderInfoClick }: ColumnProps) {
  return (
    <TableCell 
    ...
    >
      <div className="flex flex-col gap-2.5">
        ...
        <div className="min-h-[26px] flex items-center">
          <div className={`h-7 px-2 flex items-center justify-center w-1/2 rounded text-xs ${getStatusColor(order.status)}`}>
            {order.status}
          </div>
        </div>
