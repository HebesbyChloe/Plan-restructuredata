...
5. **mkt_promotions** - Promotions
6. **mkt_promotion_campaigns** - Promotion-campaign junction
7. **mkt_promotion_channels** - Promotion-channel junction
8. **mkt_promotion_products** - Promotion-product junction
9. **mkt_promotion_categories** - Promotion-category junction
10. **mkt_promotion_attributes** - Promotion-attribute junction
11. **mkt_promotion_exclusions** - Promotion exclusions
12. **mkt_promotion_bmgm_products** - BMGM products junction
13. **mkt_promotion_free_items** - Free items for promotions
14. **mkt_asset_folders** - Asset folders
15. **mkt_marketing_assets** - Marketing assets
16. **mkt_brand_settings** - Brand identity (single row)
17. **mkt_brand_colors** - Brand colors
18. **mkt_brand_typography** - Brand typography
19. **mkt_brand_logos** - Brand logos
20. **mkt_brand_guidelines** - Brand guidelines
21. **mkt_affiliates** - Affiliates/KOLs/Influencers
22. **mkt_utm_links** - UTM tracking links
23. **mkt_reference_documents** - Reference documents
24. **mkt_marketing_channels** - Marketing channels
25. **mkt_campaign_activities_history** - Activity change history
26. **mkt_promotion_redemptions** - Promotion redemption tracking
...
- **Full Integration**: Campaigns integrate with project and task system
- **Unified Task System**: All campaign tasks use `task` table with metadata
- **Flexibility**: Marketing-specific data stored in JSONB metadata fields
...
- **Projects**: Campaigns link to `project` table via `mkt_campaign_projects` junction table
- **Tasks**: Campaign tasks use unified `task` table with campaign context in metadata
- **Files**: Campaign files use `project_repository` table

### When to Use What (Campaign Activities)
